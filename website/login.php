...
<head>
	...
	<meta name="description" content="Your onestop for all your images">
...
<body>
	...
	<div>
		<form method="post" action="login.php" id="usernameForm">
			...
			<br/>
			<input type="checkbox" name="saveLocal" id="saveLocal" value="saveLocal"/> Save username
			<br/>
			<input type="checkbox" name="saveSession" id="saveSession" value="saveSession"/> Save session
			</br>
		</form>
	</div>
